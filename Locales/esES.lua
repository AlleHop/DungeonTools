...
L["Please report any bugs on https://github.com/LetsTimeIt/DungeonTools/issues"] = "Por favor, informe de cualquier error en https://github.com/LetsTimeIt/DungeonTools/issues"
