...
L["Please report any bugs on https://github.com/LetsTimeIt/DungeonTools/issues"] = "Bitte alle Fehler auf https://github.com/LetsTimeIt/DungeonTools/issues melden"
