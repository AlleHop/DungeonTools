...
L["Please report any bugs on https://github.com/LetsTimeIt/DungeonTools/issues"] = "Veuillez signaler tout bugs sur https://github.com/LetsTimeIt/DungeonTools/issues"
