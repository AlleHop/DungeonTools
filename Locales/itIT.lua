...
L["Please report any bugs on https://github.com/LetsTimeIt/DungeonTools/issues"] = "Ti preghiamo di segnalare eventuali bug all'indirizzo: https://github.com/LetsTimeIt/DungeonTools/issues"
